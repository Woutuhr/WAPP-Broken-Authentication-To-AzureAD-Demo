...
using BrokenAuthenticationMVC.Data;
using BrokenAuthenticationMVC.Models;
using Microsoft.AspNetCore.Authorization;

namespace BrokenAuthenticationMVC.Controllers
{
    [Authorize]
    public class TodosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Done")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Done")] Todo todo)
        {
            if (id != todo.Id)
            {
                return NotFound();
